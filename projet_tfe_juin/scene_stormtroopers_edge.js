...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            rect: ['499px', '275px', '431px', '176px', 'auto', 'auto'],
                            opacity: '1',
                            text: "<p style=\"margin: 0px; font-family: alice, serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 32px; color: rgb(255, 255, 255); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: normal;\">Où les Stormtroopers viennent</p><p style=\"margin: 0px; font-family: alice, serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 32px; color: rgb(255, 255, 255); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: normal;\">​encore de remporter la victoire.</p><p></p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [32, "px"], "rgba(0,0,0,1)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        }
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("scene_stormtroopers_edgeActions.js");
})("EDGE-24283699");
